...
const MISIONES_DATA: Record<number, MisionData> = {
  1905: {
    ...
    anchoMundo: 30,
    tresScene: { anchoMundo: 30, nieve: true, multitud: false, hora: 'noche', colorFondo: 0x0d0d1a, colorSuelo: 0x2a2a3a },
  ...
  1917.1: {
    ...
    anchoMundo: 35,
    tresScene: { anchoMundo: 35, nieve: true, multitud: false, hora: 'noche', colorFondo: 0x050510, colorSuelo: 0x334455 },
  ...
  1918: {
    ...
    anchoMundo: 30,
    tresScene: { anchoMundo: 30, nieve: true, multitud: false, hora: 'noche', colorFondo: 0x1a1010, colorSuelo: 0x332222 },
  ...
  1918.1: {
    ...
    anchoMundo: 25,
    tresScene: { anchoMundo: 25, nieve: false, multitud: false, hora: 'noche', colorFondo: 0x0a0505, colorSuelo: 0x221111 },
  ...
  1921: {
    ...
    anchoMundo: 30,
    tresScene: { anchoMundo: 30, nieve: true, multitud: true, hora: 'noche', colorFondo: 0x0a0a15, colorSuelo: 0x223344 },
